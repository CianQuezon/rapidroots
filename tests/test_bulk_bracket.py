...
from rapidroots.utils.bulk_bracket import BulkBracketFinder  # Replace with actual import
...
class TestVectorBracketFinder:
    ...
    def test_basic_bracket_finding_linear(self, real_dispatcher):
        ...
        left, right = BulkBracketFinder.auto_bracket_search(
    ...
    def test_concat_threshold_behavior(self, mock_dispatcher):
        ...
        left1, right1 = BulkBracketFinder.auto_bracket_search(
            mock_dispatcher, func_types, params_array, initial_guess,
            concat_threshold=10
        )
        ...
        left2, right2 = BulkBracketFinder.auto_bracket_search(
            mock_dispatcher, func_types, params_array, initial_guess,
            concat_threshold=3
        )
    ...
    def test_max_range_limiting(self, mock_dispatcher):
        ...
        with pytest.raises(ValueError, match="Failed to bracket"):
            BulkBracketFinder.auto_bracket_search(
                mock_dispatcher, func_types, params_array, initial_guess,
